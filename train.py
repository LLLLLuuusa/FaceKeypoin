...
def trainer(ops):
    ...
    # 读取模型
    model = resnet18(landmarks_num=ops.num_classes,dropout_factor=ops.dropout)
    ...
    for epoch in range(epochs):
        ...
        with trange(len(dataloader)) as t:
            for step in t:
                ...
                post = f"lr: {init_lr:.8f} total_loss: {loss:.2f}"
...
if __name__ == '__main__':
    ...
    parser.add_argument('--train_path', type=str,
        default = './data/test_wiki_crop_face/label_new/',
        help = 'train_path')# 训练集标注信息

    parser.add_argument('--pretrained', type=bool, default = True,
        help = 'imageNet_Pretrain') # 初始化学习率
    parser.add_argument('--fintune_model', type=str, default = 'weight/faceKeypoint',
